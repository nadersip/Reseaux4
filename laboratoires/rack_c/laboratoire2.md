...
Écrire une ACL standard nommée ALLOW_SSH qui permettra seulement au RACK C-PC1 de faire une connexion SSH sur RACK-C-R1. Toute tentatives de connexion via SSH depuis tout autre périphérique doit échouer.
...
•	Pour RACK C-PC1: autorise le trafic Telnet (23), DNS (53), DHCP(67, 68),  HTTP (80) et HTTPS (443) sur le serveur 192.168.30.200, tout autre trafic partant de RACK C-PC1 vers le serveur externe est refusé.

•	Pour RACK C-PC2: autorise le trafic FTP (20, 21) et DHCP(67, 68) sur le serveur 192.168.30.200.
