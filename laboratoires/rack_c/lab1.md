...
|RACK-C-R2 |G0/0/1   |10.0.0.6   |255.255.255.252| N/A|Connexion au routeur R1
...
|----------|--------------|---------------|
|RACK-C-SW1, RACK-C-SW2 et RACK-C-SW3|VLAN 50| VLAN60
|          |VLAN 50| VLAN60
|          |VLAN 99| Mgmt_Native
...
•	Bloque le traffic web en provenance du réseau 172.16.50.0/24 vers le serveur le web (on souhaite ici interdit l’accès aux pages web).
