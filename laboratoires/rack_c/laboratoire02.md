...
Écrire une ACL standard nommée ALLOW_SSH qui permettra seulement le réseaux du VLAN50 de faire une connexion SSH sur RACK-C-R1. Toute tentatives de connexion via SSH depuis tout autre périphérique doit échouer.
...
🔴 Accéder à une page web www.rack-c.local en HTTP (http://www.rack-c.local) et HTTPS (https://www.rack-c.local).
...
•	Autorise le trafic Telnet (23), DNS (53), DHCP(67, 68), HTTP (80) et HTTPS (443) du VLAN50 sur le serveur 192.168.30.200, tout autre trafic partant du VLAN50 vers le serveur externe est refusé.

•	Autorise le trafic FTP (20, 21) et DHCP(67, 68) du VLAN60 sur le serveur 192.168.30.200, tout autre trafic partant du VLAN60 vers le serveur externe est refusé.
...
e. Faites la commande show ip access-list sur le routeur RACK-C-R2, on doit voir des (match).