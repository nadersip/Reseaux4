...
a. À l’aide du tableau d’adresses IP, configurez uniquement les adresses IP sur l’interface G0/0/1 des routeurs RACK-C-R1-MTL, RACK-C-R2-Ottawa ainsi que sur l’ISP.
...
# Étape 4 – Configurez SSH sur le routeur RACK-C-R1-MTL et RACK-C-R2-Ottawa.

a. Définissez le nom de domaine à rack-c.local
...
a. À l’aide du RACK-C-PC3, connectez-vous au serveur 192.168.30.200 en SSH en utilisant le nom d’utilisateur « user » et le mot de passe « cisco1234 ».
...
c. Déplacez-vous dans le répertoire Reseaux4/laboratoires/rack_c/laboratoire12.

d. Exécutez la commande suivante pour configurer le routeur RACK-C-R1-MTL.

ansible-playbook config_rack_c_r1_mtl.yaml -i inventory.ini

e. Exécutez la commande suivante pour configurer le routeur RACK-C-R2-Ottawa.

ansible-playbook config_rack_c_r2_ottawa.yaml -i inventory.ini
...
a. Configurer le serveur Zabbix pour se connecter aux routeurs RACK-C-R1-MTL et RACK-C-R2-Ottawa. Suivre la documentation [SNMP](../../documentation/snmp_client.md).

# Étape 7 – Sauvegarde des configurations sur le serveur TFTP

a. Effectuer la sauvegarde des configurations des routeurs vers le serveur TFTP (192.168.30.200).
...
b. Vous devez effectuer un traceroute entre le PC RACK-C-PC1 et www.rack-c.local. Le trafic ne doit pas passer dans le tunnel.

c. Vous devez effectuer un traceroute entre le PC RACK-C-PC2 et www.rack-c.local. Le trafic ne doit pas passer dans le tunnel.

d. Ouvrir www.google.com dans le navigateur web sur RACK-C-PC1. Vous devez être capable d’ouvrir cette page.

e. Ouvrir www.google.com dans le navigateur web sur RACK-C-PC2. Vous devez être capable d’ouvrir cette page.
