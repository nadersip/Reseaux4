...
a. Effectuer un ping du serveur externe (192.168.60.200) vers le PC RACK-F-PC1.

b. Exécuter la commande show ip access-list sur le routeur RACK-F-R2. On doit voir des match sur toutes les lignes.