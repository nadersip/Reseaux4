...
•	Pour RACK F-PC1: Autorise le trafic Telnet (23), DNS (53), HTTP (80) et HTTPS (443) sur le serveur 192.168.60.200, tout autre trafic partant de RACK F-PC1 vers le serveur externe est refusé.

•	Pour RACK F-PC2: autorise seulement FTP (ports 20 et 21) sur le serveur 192.168.60.200.
