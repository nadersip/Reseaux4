...
# Étape 4 – Configurez SSH sur le routeur RACK-F-R1-MTL et RACK-F-R2-Ottawa.

a. Définissez le nom de domaine à rack-f.local
...
a. À l’aide du RACK-F-PC3, connectez-vous au serveur 192.168.60.200 en SSH en utilisant le nom d’utilisateur « user » et le mot de passe « cisco1234 ».
...
c. Déplacez-vous dans le répertoire Reseaux4/laboratoires/rack_f/laboratoire12.

d. Exécutez la commande suivante pour configurer le routeur RACK-F-R1-MTL.

ansible-playbook config_rack_f_r1_mtl.yaml -i inventory.ini

e. Exécutez la commande suivante pour configurer le routeur RACK-F-R2-Ottawa.

ansible-playbook config_rack_f_r2_ottawa.yaml -i inventory.ini
...
a. Configurer le serveur Zabbix pour se connecter aux routeurs RACK-F-R1-MTL et RACK-F-R2-Ottawa. Suivre la documentation [SNMP](../../../documentation/snmp_client.md).

# Étape 7 – Sauvegarde des configurations sur le serveur TFTP

a. Effectuer la sauvegarde des configurations des routeurs vers le serveur TFTP (192.168.60.200).
...
d. Ouvrir www.google.com dans le navigateur web sur RACK-F-PC1. Vous devez être capable d’ouvrir cette page.

e. Ouvrir www.google.com dans le navigateur web sur RACK-F-PC2. Vous devez être capable d’ouvrir cette page.
