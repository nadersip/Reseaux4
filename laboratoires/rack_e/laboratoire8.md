...
a.  Configurer les routeurs et les commutateurs afin qu’ils utilisent le serveur de votre rack (192.168.50.200) en tant que serveur NTP.

# Étape 8 – Configuration Syslog.

a.  Configurer les routeurs et les commutateurs afin qu’ils utilisent le serveur de votre rack (192.168.50.200) en tant que serveur Syslog.
...
•	Autorise le trafic FTP (ports 20 et 21), SSH (22), DNS (53), HTTPS (443) et NTP (123) provenant du serveur externe (192.168.50.200) à retourner.
...
b. Vous devez effectuer un traceroute entre le PC RACK-E-PC1 et www.rack-e.local. Le trafic ne doit pas passer dans le tunnel (Avant d’appliquer l’ACL FIREWALL).

c. Vous devez effectuer un traceroute entre le PC RACK-E-PC2 et www.rack-e.local. Le trafic ne doit pas passer dans le tunnel (Avant d’appliquer l’ACL FIREWALL).
