...
•	Pour RACK E-PC1: Autorise le trafic Telnet (23), DNS (53), HTTP (80) et HTTPS (443) sur le serveur 192.168.50.200, tout autre trafic partant de RACK E-PC1 vers le serveur externe est refusé.
