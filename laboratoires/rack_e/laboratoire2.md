...
Écrire une ACL standard nommée ALLOW_SSH qui permettra seulement le réseaux du VLAN90 de faire une connexion SSH sur RACK-E-R1. Toute tentatives de connexion via SSH depuis tout autre périphérique doit échouer.
...
🔴 Accéder à une page web www.rack-e.local en HTTP (http://www.rack-e.local) et HTTPS (https://www.rack-e.local).
...
•	Autorise le trafic Telnet (23), DNS (53), DHCP(67, 68), HTTP (80) et HTTPS (443) du VLAN90 sur le serveur 192.168.50.200, tout autre trafic partant du VLAN90 vers le serveur externe est refusé.

•	Autorise le trafic FTP (20, 21) et DHCP(67, 68) du VLAN100 sur le serveur 192.168.50.200, tout autre trafic partant du VLAN100 vers le serveur externe est refusé.
