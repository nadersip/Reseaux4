...
a.  Créer une liste d’accès étendue nommée QoS sur RACK-E-R1-MTL afin de faire correspondre le trafic provenant de l’adresse IP publique du routeur vers n’importe quelle destination sur le port 443.
...
e.  Créer une liste d’accès étendue nommée QoS sur RACK-E-R2-Ottawa afin de faire correspondre le trafic provenant de l’adresse IP publique du routeur vers n’importe quelle destination sur le port 443.
