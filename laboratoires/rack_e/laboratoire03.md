...
c.	Créer un NAT statique pour le PC RACK-E-PC1 avec l’adresse 10.10.10.38.
...
a. Exécuter la commande show ip access-list sur le routeur RACK-E-R1. On doit voir des match sur toutes les lignes.
