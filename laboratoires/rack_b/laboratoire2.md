...
•	Pour RACK B-PC1: Autorise le trafic Telnet (23), DNS (53), HTTP (80) et HTTPS (443) sur le serveur 192.168.10.200, tout autre trafic partant de RACK B-PC1 vers le serveur externe publique est refusé.
