...
c.	Créer un NAT statique pour le PC RACK-B-PC1 avec l’adresse 10.10.10.14.
...
a. Exécuter la commande show ip access-list sur le routeur RACK-B-R1. On doit voir des match sur toutes les lignes.
