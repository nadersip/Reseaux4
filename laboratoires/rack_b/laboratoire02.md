...
Écrire une ACL standard nommée ALLOW_SSH qui permettra seulement le réseaux du VLAN30 de faire une connexion SSH sur RACK-B-R1. Toute tentatives de connexion via SSH depuis tout autre périphérique doit échouer.
...
•	Autorise le trafic Telnet (23), DNS (53), DHCP(67, 68), HTTP (80) et HTTPS (443) du VLAN30 sur le serveur 192.168.20.200, tout autre trafic partant du VLAN30 vers le serveur externe est refusé.

•	Autorise le trafic FTP (20, 21) et DHCP(67, 68) du VLAN40 sur le serveur 192.168.20.200, tout autre trafic partant du VLAN40 vers le serveur externe est refusé.
...
e. Faites la commande show ip access-list sur le routeur RACK-B-R2, on doit voir des (match).