...
b. Vous devez effectuer un traceroute entre le PC RACK-B-PC1 et www.rack-b.local. Le trafic ne doit pas passer dans le tunnel (Avant d’appliquer l’ACL FIREWALL).

c. Vous devez effectuer un traceroute entre le PC RACK-B-PC2 et www.rack-b.local. Le trafic ne doit pas passer dans le tunnel (Avant d’appliquer l’ACL FIREWALL).
