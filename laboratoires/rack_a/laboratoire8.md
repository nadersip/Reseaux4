...
•	Autorise le trafic FTP (ports 20 et 21), SSH (22), DNS (53), HTTPS (443) et NTP (123) provenant du serveur externe (192.168.10.200) à retourner.
...
b. Vous devez effectuer un traceroute entre le PC RACK-A-PC1 et www.rack-a.local. Le trafic ne doit pas passer dans le tunnel (Avant d’appliquer l’ACL FIREWALL).

c. Vous devez effectuer un traceroute entre le PC RACK-A-PC2 et www.rack-a.local. Le trafic ne doit pas passer dans le tunnel (Avant d’appliquer l’ACL FIREWALL).
