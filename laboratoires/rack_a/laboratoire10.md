# Laboratoire 8 - Configuration GRE, NAT, TFTP, SNMP
# Topologie
...
i. Exécuter la commande "show ip access-lists" sur les routeurs RACK-A-R1-MTL et RACK-A-R2-Ottawa. Vous devez voir des correspondances (matches) sur toutes les lignes.
