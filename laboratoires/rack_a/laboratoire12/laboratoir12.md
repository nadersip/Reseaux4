...
a. Configurer une communauté read-only nommée "rack-a" sur les routeurs RACK-A-R1-MTL et RACK-A-R2-Ottawa.

b. Configurer le serveur Zabbix pour se connecter aux routeurs RACK-A-R1-MTL et RACK-A-R2-Ottawa. Suivre la documentation [SNMP](../../documentation/snmp_client.md).

# Étape 8 – Configuration des ACL étendues sur RACK-A-R1-MTL et RACK-A-R2-Ottawa
...
b. Vous devez effectuer un traceroute entre le PC RACK-A-PC1 et www.rack-a.local
. Le trafic ne doit pas passer dans le tunnel.

c. Vous devez effectuer un traceroute entre le PC RACK-A-PC2 et www.rack-a.local
. Le trafic ne doit pas passer dans le tunnel.

d. Ouvrir www.google.com
 dans le navigateur web sur RACK-A-PC1. Vous devez être capable d’ouvrir cette page.

e. Ouvrir www.google.com
 dans le navigateur web sur RACK-A-PC2. Vous devez être capable d’ouvrir cette page.
