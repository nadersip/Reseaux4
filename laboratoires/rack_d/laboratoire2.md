...
|----------|--------------|---------------|----------------|------------------|------------------|
|RACK-D-R1 |G0/0/1   |192.168.100.2       |255.255.255.248           | N/A|Connexion a internet via la switch
|          |G0/0/0   |10.0.0.5   |255.255.255.252| N/A|Connexion au routeur R2
|RACK-D-R2 |G0/0/1   |10.0.0.6   |255.255.255.252| N/A|Connexion au routeur R1
...
•	Pour RACK D-PC1: Autorise le trafic Telnet (23), DNS (53), HTTP (80) et HTTPS (443) sur le serveur 192.168.40.200, tout autre trafic partant de RACK D-PC1 vers le serveur externe publique est refusé.
•	Pour RACK D-PC2: autorise seulement FTP (ports 20 et 21) sur le serveur 192.168.40.200
