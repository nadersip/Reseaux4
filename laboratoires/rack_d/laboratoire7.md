...
a.  Créer une liste d’accès étendue nommée QoS sur RACK-D-R1-MTL afin de faire correspondre le trafic provenant du réseau 172.16.70.0/24 vers n’importe quelle destination sur le port 443.
...
e.  Créer une liste d’accès étendue nommée QoS sur RACK-D-R2-Ottawa afin de faire correspondre le trafic provenant du réseau 172.16.80.0/24 vers n’importe quelle destination sur le port 443.
