...
🔴 Connectez-vous en SSH au serveur 192.168.40.200 en utilisant l’utilisateur "user" et le mot de passe "cisco1234", puis essayez de pinguer le PC RACK-D-PC1.
...
•	Autorise le retour du trafic FTP (ports 20 et 21), SSH(22), DNS (53), HTTPS (443) du serveur externe (192.168.40.200) au réseaux du VLAN70 et VLAN80.

•	Autorise les pings du serveur externe (192.168.40.200) vers le PC RACK-D-PC1.

•	Interdire tout autres trafics.

# Captures à remettre dans le pigeonnier

a. Effectuer un ping du serveur externe (192.168.40.200) vers le PC RACK-D-PC1.

b. Exécuter la commande show ip access-list sur le routeur RACK-D-R2. On doit voir des match sur toutes les lignes.