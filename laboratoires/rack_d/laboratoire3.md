...
a. Exécuter la commande show ip access-list sur le routeur RACK-D-R1. On doit voir des match sur toutes les lignes.

b. Exécuter la commande show ip nat translations sur le routeur RACK-D-R1.