...
🔴 Accéder à une page web www.rack-d.local en HTTP (http://www.rack-d.local) et HTTPS (https://www.rack-d.local).
...
e. Faites la commande show ip access-list sur le routeur RACK-D-R2, on doit voir des (match).